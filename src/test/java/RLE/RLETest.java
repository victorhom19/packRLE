...
class RLETest {
    ...
    void packingTest_1() throws IOException, CmdLineException {
        ...
        assertFileContent(new File("src/test/resources/PackingTesting/OutputPackingTest.txt"),
                 "5a3b3e");
    ...
    void unpackingTest_1() throws IOException, CmdLineException {
        ...
        new PackRLE().main(args);
        assertFileContent(new File("src/test/resources/UnpackingTesting/OutputUnpackingTest.txt"),
    ...
    void complexTest_1() throws IOException, CmdLineException {
        ...
        assertEquals(getContent(new File("src/test/resources/ComplexTesting/ComplexTestOriginal_1.txt")),
                     getContent(new File("src/test/resources/ComplexTesting/ComplexTestModified_1.txt")));
    }
    ...
    void complexTest_2() throws IOException, CmdLineException {
        ...
        String[] unpackingArgs = {"-u", "-out", "src/test/resources/ComplexTesting/ComplexTestModified_2.txt",
                "src/test/resources/ComplexTesting/temp.txt"};
        new PackRLE().main(unpackingArgs);
        assertEquals(getContent(new File("src/test/resources/ComplexTesting/ComplexTestOriginal_2.txt")),
                     getContent(new File("src/test/resources/ComplexTesting/ComplexTestModified_2.txt")));
    }
    ...
    void slashTest_1() throws IOException, CmdLineException {
        ...
        new PackRLE().main(args);
        assertFileContent(new File("src/test/resources/SlashTesting/temp.txt"),
